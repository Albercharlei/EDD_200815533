<%@ Page Title="" Language="C#" MasterPageFile="~/master/masterjuegos/masterpartidas.Master" AutoEventWireup="true" CodeBehind="historial.aspx.cs" Inherits="ProyectServer.master.masterjuegos.WebForm7" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="server">
    <asp:Image runat="server" ID="grafob" />
</asp:Content>
