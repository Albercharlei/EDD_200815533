<%@ Page Title="" Language="C#" MasterPageFile="~/master/masterusers/masterusers.Master" AutoEventWireup="true" CodeBehind="hash.aspx.cs" Inherits="ProyectServer.master.masterusers.WebForm4" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="server">
    <asp:Label runat="server" ID="labelsize" />
    <asp:Image runat ="server" ID="tablahash" />
    <div></div>
    <asp:label runat="server" ID="labelocupacion" />
